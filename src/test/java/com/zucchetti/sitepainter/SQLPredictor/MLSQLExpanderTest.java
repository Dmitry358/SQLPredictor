...
public class MLSQLExpanderTest {
    ...
    public void testTranslateWithLRPredictor(){
        String request = "<       lr_moto   >(       t.km1 + left(t.nome1_1,11) + left(t.nome1_2,12) + left(t.nome1_3,13),  tccc +44,  t.km2 +  left(t.nome2_1,21) +   left(t.nome2_2,22) , t.zzz  )";
        MLSQLExpander expander = new MLSQLExpander();
    ...
    public void testTranslateWithSVMPredictorLinearKernel(){
        String request = "<       svm_linear   >(       t.km1 + left(t.nome1_1,11) + left(t.nome1_2,12) + left(t.nome1_3,13),  tccc +44,  t.km2 +  left(t.nome2_1,21) +   left(t.nome2_2,22) , t.zzz  )";
        MLSQLExpander expander = new MLSQLExpander();
    ...
    public void testTranslateWithSVMPredictorPolynomialKernel(){
        String request = "<       svm_polynomial   >(       t.km1 + left(t.nome1_1,11) + left(t.nome1_2,12) + left(t.nome1_3,13),  tccc +44,  t.km2 +  left(t.nome2_1,21) +   left(t.nome2_2,22) , t.zzz  )";
        MLSQLExpander expander = new MLSQLExpander();
    ...
    public void testTranslateWithSVMPredictorRBFKernel(){
        String request = "<       svm_rbf   >(       t.km1 + left(t.nome1_1,11) + left(t.nome1_2,12) + left(t.nome1_3,13),  tccc +44,  t.km2 +  left(t.nome2_1,21) +   left(t.nome2_2,22) , t.zzz  )";
        MLSQLExpander expander = new MLSQLExpander();
    ...
    public void testTranslateWithABCPredictorWhenNumberOfFieldsPassedGreaterThanRequired(){
        ...
        String request = "<   abc_good     >( t.aaaa, t.bbbb       )";
